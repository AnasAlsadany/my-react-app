  ...
  return (
    <div className={`py-5`}>
      <Container className="text-center">
        ...
        <h1 className="custom-hero-title mb-3">
          The Finance Solutions <br /> For Your Business
        </h1>

        <p
          className="display-10 mb-3"
          style={{ color: isDark ? "#9B9CA1" : "inherit" }}
        >
        ...
        <Row className="justify-content-center mb-4">
          <Col md={8} lg={6}>
            <InputGroup className="mb-3">
              ...
              />
        <SharedButton variant="auto" className="rounded-end-pill px-4 fw-semibold">
  Book a Demo
</SharedButton>
